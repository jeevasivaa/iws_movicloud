  ...
  return (
    <div className="min-h-screen bg-gray-50 text-slate-900">
      ...
      <header className="fixed top-0 z-40 flex h-20 w-full items-center justify-between border-b border-slate-200 bg-white px-4 sm:px-6 lg:pl-24 lg:pr-8">
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.16em] text-emerald-600">Staff Portal</p>
          <p className="text-xl font-semibold text-slate-900 sm:text-2xl">Active Shift: Raj</p>
        </div>

        <button
          type="button"
          onClick={handleLogout}
          className="inline-flex items-center gap-2 rounded-2xl border border-red-200 bg-red-50 px-4 py-3 text-base font-semibold text-red-700 transition-colors hover:bg-red-100"
        >
          <LogOut size={18} />
          Logout
        </button>
