...
function StaffOrders() {
  ...
  return (
    <section className="space-y-5 pb-20 sm:pb-4">
      <header>
        <h1 className="text-3xl font-black text-slate-900 sm:text-4xl">Order Packing / Fulfillment</h1>
      ...
      {!loading ? (
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-[360px_1fr]">
          <aside className="space-y-3 rounded-2xl border border-slate-200 bg-white p-4">
            <h2 className="text-2xl font-black text-slate-900">Pending Shipments</h2>
              ...
              <div className="space-y-2">
                {orders.map((order) => {
                  ...
                  return (
                    ...
                    >
                      <p className="text-lg font-black text-slate-900">{order.order_id || 'Order'}</p>
            ...
            {selectedOrder ? (
              <>
                <div className="space-y-1">
                  <p className="text-xs font-black uppercase tracking-[0.2em] text-emerald-600">Packing View</p>
                  <h3 className="text-3xl font-black text-slate-900">Order #{selectedOrder.order_id || 'ORD-2024-001'}</h3>
                </div>
                  ...
                  {packingItems.map((item) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className={`text-xl font-black ${checked ? 'line-through' : ''}`}>
                ...
                {allPacked ? (
                  <button
                    ...
                    className="sticky bottom-2 inline-flex w-full items-center justify-center gap-3 rounded-2xl bg-emerald-500 px-6 py-5 text-xl font-black text-white transition-colors hover:bg-emerald-600 disabled:cursor-not-allowed disabled:opacity-70"
                  >
